...
class DrawingWorkspace:
    ...
    def health(self):
        ...
        checks['drawings_hotfix_release_active']=self.ns.get('BUILD_COMMAND_RELEASE') in {VERSION,'8.15.0','8.16.0','8.17.0','8.17.1','8.18.0','8.19.0','8.20.0','8.21.0','8.22.0','8.23.0','8.24.0','8.25.0','8.26.0'}
        try:
